...
heruntergeladen und eingefügt werden\footnote{Aktuelle Versionen dieser Module
  sind auch im Repo-Verzeichnis \texttt{Drupal-Module} zu finden.}.  Eine
...
verwendet\footnote{Eine aktuelle Version ist auch im Repo-Verzeichnis
  \texttt{Drupal-Themes} zu finden.}, das die grundlegenden Elemente des
